        ...
        <>
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-9">
                        <p>Ունեմ մեծ հետաքրքրություններ էլեկտրոտեխնիկայի, ռոբոտացված համակարգերի ստեղծման և ծրագրավորման նկատմամբ։ Հետևում եմ ոլորտի զարգացումներին, մշտապես զբաղվում եմ ինքնակրթությամբ։ Ներկա պահին ուսումնասիրում եմ C# ծրագրավորման լեզուն։ Հետաքրքրված եմ նաև խաղերի ծրագրավորման ուղղությամբ։</p>
                    </div>
                </div>
            </div>
